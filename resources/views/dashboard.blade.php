                            ...
                            <div class="col mr-2">
                                ...
                                <div class="h3 mb-0 font-weight-bold text-gray-800">
                                    <text id="outdoor-dose-rate">
                                        {{ str_replace('""','',json_encode($latestDoseRate->original['doseRateOutdoor']->dose_rate)) }}
                                    </text>
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="h3 mb-0 font-weight-bold text-gray-800">
                                    <text id="indoor-dose-rate">
                                        {{ str_replace('""','',json_encode($latestDoseRate->original['doseRateIndoor']->dose_rate)) }}
                                    </text>
                                    <sup class="font-weight-normal">&#181;Sv/jam</sup>
                                </div>
                            </div>
                            ...
                            <div class="col mr-2">
                                ...
                                <div class="h3 mb-0 font-weight-bold text-gray-800">
                                    <text id="highest-dose-rate">
                                        {{ str_replace('""','',json_encode($highestDoseRate->original['highest_dose_rate'])) }}
                                    </text>
                                    <sup class="font-weight-normal">&#181;Sv/jam</sup>
                                </div>
                            </div>
